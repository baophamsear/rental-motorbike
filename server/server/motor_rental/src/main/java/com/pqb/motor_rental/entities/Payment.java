...
//    private Rental rental;
    ...
    public Payment(Integer paymentId, PaymentMethod paymentMethod, Long amount, LocalDateTime paymentTime, PaymentStatus status, Rental rental, String txnRef, String transactionNo) {
